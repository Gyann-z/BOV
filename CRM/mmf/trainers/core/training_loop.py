...
class TrainerTrainingLoopMixin(ABC):
    ...
    def run_training_epoch(self) -> None:
        ...
        while self.num_updates < self.max_updates and not should_break:
            ...
            for idx, batch in enumerate(self.train_loader):#change
                # print(idx)
                ...
                if self.num_updates % self.training_config.evaluation_interval == 0:#self.training_config.evaluation_interval
    ...
    def _extract_loss(self, report: Dict[str, Any]) -> Tensor:
        ...
        # print(loss_dict)
        loss_related_dict=report.loss_related
        # print('rec',loss_rec_dict)
        # assert len(loss_rec_dict) != 0, (
