...
class FeatureReader:
    ...
    def read(self, image_feat_path):
        ...
        image_feat_path=image_feat_path.replace('train_images/train/','train_images/')#change
        print(image_feat_path)
...
class PaddedFasterRCNNFeatureReader:
    ...
    def _load(self, image_feat_path):
        ...
        if PathManager.exists(info_path):
            ...
            image_info.update(np.load(info_path, allow_pickle=True, encoding='latin1').item())#change
