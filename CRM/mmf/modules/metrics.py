...
#change
@registry.register_metric("recog_accuracy")
class RecogAccuracy(BaseMetric):
    def __init__(self):
        super().__init__("recog_accuracy")
        import mmf.utils.m4c_evaluators as evaluators
    ...
    def calculate(self, sample_list, model_output, *args, **kwargs):
        ...
        batch_size = sample_list.context_tokens.size(0)
        eval_res = metrics_factory[self.metric](model_output['pred_rec'], targets, dataset)
